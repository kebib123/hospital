...
<form class="form-horizontal" role="form" action="{{ url('admin/taxliability_eligibility') }}" method="post" enctype="multipart/form-data">
           {{ csrf_field() }}         
<div class="col-md-9">
            <!-- Input Fields -->
            <div class="panel">
              ...
              <div class="panel-body"> 
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <div class="bs-component">
                        <input type="text" class="form-control" name="bonus_issued"  /> <br />                       
                      </div>
                    </div>
                  </div> 
                  <div class="form-group">

...
@section('breadcrumb')
    <a href="admin/taxliability_eligibility/create" class="btn btn-primary btn-sm">Create</a>
    <a href="" data-toggle="modal" data-target=".team-details"class="btn btn-primary btn-sm">Upload CSV</a>
     <a href="admin/taxliability_eligibility/delete/all" onclick="return confirm('Do you want to Delete All?')" class="btn btn-primary btn-sm">Delete All</a>
    @endsection
@section('content')
<section id="" class="table-layout animated fadeIn">
  <!-- begin: .tray-center -->
  <div class=""> 
   <h4>Taxliability Eligibility</h4>
   <!-- recent orders table -->
   <div class="panel">
           ...
           @if(count($data) > 0)              
              ...
              <tr class="id{{$row->id}}">
                ...
                <td class="text-center">  
                  <a href="{{ url('admin/taxliability_eligibility/'.$row->id.'/edit') }}">Edit</a>|
                  <a href="{{ url('admin/taxliability_eligibility/'.$row->id.'/destroy') }}" onclick="return confirm('Confirm Delete?')"  class="btn-delete">
                    Delete
                  </a>
                </td>
              </tr>
         ...
         <div class="modal-body p-0 modal-team-body">
            ...
            <div class="modal-team-details">
               ...
               <div class="text-center">
                <form method="POST" action="{{ url('admin/taxliability_eligibility/upload_csv') }}" enctype="multipart/form-data">
                   {{ csrf_field() }}

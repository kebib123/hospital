...
@section('breadcrumb')
   <?php /*?>  <a href="admin/banner/create" class="btn btn-primary btn-sm">Create</a><?php */?>
@endsection
@section('content')
					...
					<table class="table admin-form theme-warning fs13">
						...
						<tbody>
							...
							<tr class="id{{$row->id}}">
                                ...
                                <td><img src="{{asset('uploads/banners/'.$row->picture)}}" width="15%"></td>
                                <td>{{ ucfirst($row->title) }}</td>
								<td>{!! ucfirst($row->content) !!}</td>
								<td>

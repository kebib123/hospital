            ...
            <div class="panel">
              ...
              <div class="panel-body"> 
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <div class="bs-component">
                        <input type="text" class="form-control" name="shholderno" value="{{$data->shholderno}}" /> <br />                       
                      </div>
                    </div>
                  </div> 
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <div class="bs-component">
                        <input type="text" class="form-control" name="issue_bonus"  value="{{$data->issue_bonus}}" /> <br />                       
                      </div>
                    </div>
                  </div> 
                  <div class="form-group">

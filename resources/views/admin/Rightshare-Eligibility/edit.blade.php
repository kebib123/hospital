...
<div class="col-md-9">
            ...
            <div class="panel">
              <div class="panel-heading">
                <span class="panel-title">Edit Rightshare Eligibilty</span>
              </div>
              <div class="panel-body"> 
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <div class="bs-component">
                        <input type="text" class="form-control" name="boid" placeholder="" value="{{$data->boid}}"/> <br />                       
                      </div>
                    </div>
                  </div> 
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <div class="bs-component">
                        <input type="text" class="form-control" name="kitta" value="{{$data->kitta}}"/> <br />                       
                      </div>
                    </div>
                  </div> 
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <div class="bs-component">
                        <input type="text" class="form-control" name="remaining_kitta" value="{{$data->remaining_kitta}}" /> <br />                       
                      </div>
                    </div>
                  </div> 
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <div class="bs-component">
                        <input type="text" class="form-control" name="t_frac_kitta"  value="{{$data->t_frac_kitta}}"/> <br />                       
                      </div>
                    </div>
                  </div>  
                   <div class="form-group">

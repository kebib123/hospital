...
Route::post('rightshare/check', 'FrontendControllers\FrontpageController@rightshare')->name('rightshare');
Route::post('taxliability/check', 'FrontendControllers\FrontpageController@taxliability')->name('taxliability');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::resources([
        ...
        'admin/rightshare_company' => 'AdminControllers\Rightshare\RightshareCompanyController',
        'admin/rightshare_eligibility' => 'AdminControllers\Rightshare\RightshareEligibilityController',
        'admin/rightshare_holderlist' => 'AdminControllers\Rightshare\RightshareHolderlistController',
        'admin/taxliability_company' => 'AdminControllers\TaxLiability\TaxliabilityCompanyController',
    ...
    Route::get('admin/rightshare_eligibility/delete/all', 'AdminControllers\Rightshare\RightshareEligibilityController@delete_all');
    Route::post('admin/rightshare_eligibility/upload_csv', 'AdminControllers\Rightshare\RightshareEligibilityController@upload_csv');
    Route::get('admin/rightshare_holderlist/{id}/destroy', 'AdminControllers\Rightshare\RightshareHolderlistController@destroy');
    Route::get('admin/rightshare_holderlist/delete/all', 'AdminControllers\Rightshare\RightshareHolderlistController@delete_all');
    Route::post('admin/rightshare_holderlist/upload_csv', 'AdminControllers\Rightshare\RightshareHolderlistController@upload_csv');

    //taxliability
    Route::get('admin/taxliability_company/{id}/destroy', 'AdminControllers\TaxLiability\TaxliabilityCompanyController@destroy');
    Route::get('admin/taxliability_eligibility/{id}/destroy', 'AdminControllers\TaxLiability\TaxliabilityEligibilityController@destroy');
    Route::get('admin/taxliability_eligibility/delete/all', 'AdminControllers\TaxLiability\TaxliabilityEligibilityController@delete_all');
    Route::post('admin/taxliability_eligibility/upload_csv', 'AdminControllers\TaxLiability\TaxliabilityEligibilityController@upload_csv');
    Route::get('admin/taxliability_holderlist/{id}/destroy', 'AdminControllers\TaxLiability\TaxliabilityHolderlistController@destroy');
    Route::get('admin/taxliability_holderlist/delete/all', 'AdminControllers\TaxLiability\TaxliabilityHolderlistController@delete_all');
    Route::post('admin/taxliability_holderlist/upload_csv', 'AdminControllers\TaxLiability\TaxliabilityHolderlistController@upload_csv');
